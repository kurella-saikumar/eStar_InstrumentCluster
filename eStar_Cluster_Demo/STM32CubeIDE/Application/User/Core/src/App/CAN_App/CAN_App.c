...
void HAL_FDCAN_RxFifo0Callback(FDCAN_HandleTypeDef *hfdcan, uint32_t RxFifo0ITs)
{
	...
	if((RxFifo0ITs & FDCAN_IT_RX_FIFO0_NEW_MESSAGE) != 0)
	{
		...
		else
		{
			  ...
			  {
				  CAN_RxData.Signal_1 = (RxData[0] >> 0) & 0x01;
				  CAN_RxData.Signal_2 = (RxData[0] >> 1) & 0x01;
				  CAN_RxData.Signal_3 = (RxData[0] >> 2) & 0x01;
				  CAN_RxData.Signal_4 = (RxData[0] >> 3) & 0x01;
				  CAN_RxData.Signal_5 = (RxData[0] >> 4) & 0x01;
				  CAN_RxData.Signal_6 = (RxData[0] >> 5) & 0x01;
				  CAN_RxData.Signal_7 = (RxData[0] >> 6) & 0x01;
				  CAN_RxData.Signal_8 = (RxData[0] >> 7) & 0x01;
				  CAN_RxData.Signal_9 = (RxData[1] >> 0) & 0x01;
				  CAN_RxData.Signal_10 = (RxData[1] >> 1) & 0x01;
				  CAN_RxData.Signal_11 = (RxData[1] >> 2) & 0x01;
				  CAN_RxData.Signal_12 = (RxData[1] >> 3) & 0x01;
				  CAN_RxData.Signal_13 = (RxData[1] >> 4) & 0x01;
				  CAN_RxData.Signal_14 = (RxData[1] >> 5) & 0x01;
			  }
			  else
			  {
