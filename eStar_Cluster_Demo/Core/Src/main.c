...
extern unsigned char ucImage_highbeam1_HypRAM[75*128];
extern unsigned char ucImage_highbeam2_HypRAM[75*128];
...
extern unsigned char ucImage_rpmicon1_HypRAM[75*128];
extern unsigned char ucImage_rpmicon2_HypRAM[75*128];
...
void Disp_imgDataHyperRAM_Init(void)
{
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_highbeam1_HypRAM,Address22,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-24\n\r");
#endif
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_highbeam2_HypRAM,Address23,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-25\n\r");
#endif
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_leftindicator1_HypRAM,Address24,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-26\n\r");
#endif
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_leftindicator2_HypRAM,Address25,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-27\n\r");
#endif
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_lowbattery1_HypRAM,Address26,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-28\n\r");
#endif
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_lowbattery2_HypRAM,Address27,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-29\n\r");
#endif
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_lowbeam1_HypRAM,Address28,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-30\n\r");
#endif
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_lowbeam2_HypRAM,Address29,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-31\n\r");
#endif
	...
	uint32_t Address30= (uint32_t )(&image_parking_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_parking_r_HypRAM,Address30,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-32\n\r");
#endif
	...
	uint32_t Address31= (uint32_t )(&image_parking_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_parking_w_HypRAM,Address31,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-33\n\r");
#endif
	...
	uint32_t Address32= (uint32_t )(&image_rightindicator1_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rightindicator1_HypRAM,Address32,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-34\n\r");
#endif
	...
	uint32_t Address33= (uint32_t )(&image_rightindicator2_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rightindicator2_HypRAM,Address33,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-35\n\r");
#endif
	...
	uint32_t Address34= (uint32_t )(&image_rpmbar01_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar01_HypRAM,Address34,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-36\n\r");
#endif
	...
	uint32_t Address35= (uint32_t )(&image_rpmbar02_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar02_HypRAM,Address35,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-37\n\r");
#endif
	...
	uint32_t Address36= (uint32_t )(&image_rpmbar03_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar03_HypRAM,Address36,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-38\n\r");
#endif
	...
	uint32_t Address37= (uint32_t )(&image_rpmbar04_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar04_HypRAM,Address37,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-39\n\r");
#endif
	...
	uint32_t Address38= (uint32_t )(&image_rpmbar05_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar05_HypRAM,Address38,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-40\n\r");
#endif
	...
	uint32_t Address39= (uint32_t )(&image_rpmbar06_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar06_HypRAM,Address39,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-41\n\r");
#endif
	...
	uint32_t Address40= (uint32_t )(&image_rpmbar07_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar07_HypRAM,Address40,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-42\n\r");
#endif
	...
	uint32_t Address41= (uint32_t )(&image_rpmbar08_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar08_HypRAM,Address41,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-43\n\r");
#endif
	...
	uint32_t Address42= (uint32_t )(&image_rpmbar09_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar09_HypRAM,Address42,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-44\n\r");
#endif
	...
	uint32_t Address43= (uint32_t )(&image_rpmbar10_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmbar10_HypRAM,Address43,(75*128*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-45\n\r");
#endif
	...
	uint32_t Address44= (uint32_t )(&image_rpmicon1_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmicon1_HypRAM,Address44,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-46\n\r");
#endif
	...
	uint32_t Address45= (uint32_t )(&image_rpmicon2_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_rpmicon2_HypRAM,Address45,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-47\n\r");
#endif
	...
	uint32_t Address46= (uint32_t )(&image_seatbelt_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_seatbelt_r_HypRAM,Address46,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-48\n\r");
#endif
	...
	uint32_t Address47= (uint32_t )(&image_seatbelt_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_seatbelt_w_HypRAM,Address47,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-49\n\r");
#endif
	...
	uint32_t Address48= (uint32_t )(&image_servicereminder_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_servicereminder_w_HypRAM,Address48,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-50\n\r");
#endif
	...
	uint32_t Address49= (uint32_t )(&image_servicereminder_y_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_servicereminder_y_HypRAM,Address49,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-51\n\r");
#endif
	...
	uint32_t Address50= (uint32_t )(&image_tempicon1_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_tempicon1_HypRAM,Address50,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-52\n\r");
#endif
	...
	uint32_t Address51= (uint32_t )(&image_tempicon2_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucImage_tempicon2_HypRAM,Address51,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-53\n\r");
#endif
