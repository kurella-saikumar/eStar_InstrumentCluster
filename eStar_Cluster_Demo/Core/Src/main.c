...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
KEEP extern const unsigned char image_abs_detection_r_const[];
KEEP extern const unsigned char image_abs_detection_w_const[];
KEEP extern const unsigned char image_background_const[];
KEEP extern const unsigned char image_doorsicon_r_const[];
KEEP extern const unsigned char image_doorsicon_w_const[];
KEEP extern const unsigned char image_engineoil_r_const[];
KEEP extern const unsigned char image_engineoil_w_const[];
...
KEEP extern const unsigned char image_fuelicon_r_const[];
KEEP extern const unsigned char image_fuelicon_w_const[];
KEEP extern const unsigned char image_highbeam_blue_const[];
KEEP extern const unsigned char image_highbeam_r_const[];
KEEP extern const unsigned char image_highbeam_w_const[];
KEEP extern const unsigned char image_highbeam_wb_const[];
KEEP extern const unsigned char image_leftindicator_r_const[];
KEEP extern const unsigned char image_leftindicator_w_const[];
KEEP extern const unsigned char image_lowbatteryicon_r_const[];
KEEP extern const unsigned char image_lowbatteryicon_w_const[];
KEEP extern const unsigned char image_lowbeam_r_const[];
KEEP extern const unsigned char image_lowbeam_w_const[];
KEEP extern const unsigned char image_parking_r_const[];
KEEP extern const unsigned char image_parking_w_const[];
KEEP extern const unsigned char image_rightindicator_r_const[];
KEEP extern const unsigned char image_rightindicator_w_const[];
...
KEEP extern const unsigned char image_rpmicon_r_const[];
KEEP extern const unsigned char image_rpmicon_w_const[];
...
KEEP extern const unsigned char image_temperature_r_const[];
KEEP extern const unsigned char image_temperature_w_const[];
...
void Disp_imgDataHyperRAM_Init(void)
{
	...
	memset(ucimage_engineoil_r_HypRAM,0 ,(64*64));
	memset(ucimage_engineoil_w_HypRAM,0 ,(64*64));
	...
	memset(ucimage_fuelicon_r_HypRAM, 0 ,(64*64));
	memset(ucimage_fuelicon_w_HypRAM, 0 ,(64*64));
	memset(ucimage_highbeam_blue_HypRAM, 0 ,(64*64));
	memset(ucimage_highbeam_r_HypRAM, 0 ,(64*64));
	memset(ucimage_highbeam_w_HypRAM, 0 ,(64*64));
	memset(ucimage_highbeam_wb_HypRAM, 0 ,(64*64));
	memset(ucimage_leftindicator_r_HypRAM, 0 ,(64*64));
	memset(ucimage_leftindicator_w_HypRAM, 0 ,(64*64));
	memset(ucimage_lowbatteryicon_r_HypRAM, 0 ,(64*64));
	memset(ucimage_lowbatteryicon_w_HypRAM, 0 ,(64*64));
	memset(ucimage_lowbeam_r_HypRAM, 0 ,(64*64));
	memset(ucimage_lowbeam_w_HypRAM, 0 ,(64*64));
	memset(ucimage_parking_r_HypRAM, 0 ,(64*64));
	memset(ucimage_parking_w_HypRAM, 0 ,(64*64));
	memset(ucimage_rightindicator_r_HypRAM, 0 ,(64*64));
	memset(ucimage_rightindicator_w_HypRAM, 0 ,(64*64));
	...
	memset(ucimage_rpmicon_r_HypRAM, 0 ,(64*64));
	memset(ucimage_rpmicon_w_HypRAM, 0 ,(64*64));
	...
	memset(ucimage_temperature_r_HypRAM, 0 ,(64*64));
	memset(ucimage_temperature_w_HypRAM, 0 ,(64*64));

#if 1
	uint32_t Address1= (uint32_t )(&image_abs_detection_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_abs_detection_r_HypRAM,Address1,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-1\n\r");
#endif
	...
	uint32_t Address2= (uint32_t )(&image_abs_detection_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_abs_detection_w_HypRAM,Address2,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-2\n\r");
#endif
	...
	uint32_t Address4= (uint32_t )(&image_fuelicon_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_fuelicon_r_HypRAM,Address4,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-4\n\r");
#endif
	...
	uint32_t Address5= (uint32_t )(&image_fuelicon_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_fuelicon_w_HypRAM,Address5,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-5\n\r");
#endif
	...
	uint32_t Address6= (uint32_t )(&image_doorsicon_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_doorsicon_r_HypRAM,Address6,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-6\n\r");
#endif
	...
	uint32_t Address8= (uint32_t )(&image_engineoil_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_engineoil_r_HypRAM,Address8,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-8\n\r");
#endif
	...
	uint32_t Address9= (uint32_t )(&image_engineoil_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_engineoil_r_HypRAM,Address9,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-9\n\r");
#endif
	...
	uint32_t Address24= (uint32_t )(&image_highbeam_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_highbeam_r_HypRAM,Address24,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-24\n\r");
#endif
	...
	uint32_t Address25= (uint32_t )(&image_highbeam_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_highbeam_w_HypRAM,Address25,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-25\n\r");
#endif
	...
	uint32_t Address26= (uint32_t )(&image_leftindicator_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_leftindicator_r_HypRAM,Address26,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-26\n\r");
#endif
	...
	uint32_t Address27= (uint32_t )(&image_leftindicator_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_leftindicator_w_HypRAM,Address27,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-27\n\r");
#endif
	...
	uint32_t Address28= (uint32_t )(&image_lowbatteryicon_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_lowbatteryicon_r_HypRAM,Address28,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-28\n\r");
#endif
	...
	uint32_t Address29= (uint32_t )(&image_lowbatteryicon_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_lowbatteryicon_w_HypRAM,Address29,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-29\n\r");
#endif
	...
	uint32_t Address30= (uint32_t )(&image_lowbeam_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_lowbeam_r_HypRAM,Address30,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-30\n\r");
#endif
	...
	uint32_t Address31= (uint32_t )(&image_lowbeam_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_lowbeam_w_HypRAM,Address31,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-31\n\r");
#endif
	...
	uint32_t Address34= (uint32_t )(&image_rightindicator_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_rightindicator_r_HypRAM,Address34,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-34\n\r");
#endif
	...
	uint32_t Address35= (uint32_t )(&image_rightindicator_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_rightindicator_w_HypRAM,Address35,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-35\n\r");
#endif
	...
	uint32_t Address46= (uint32_t )(&image_rpmicon_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_rpmicon_r_HypRAM,Address46,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-46\n\r");
#endif
	...
	uint32_t Address47= (uint32_t )(&image_rpmicon_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_rpmicon_w_HypRAM,Address47,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-47\n\r");
#endif
	...
	uint32_t Address52= (uint32_t )(&image_temperature_r_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_temperature_r_HypRAM,Address52,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-52\n\r");
#endif
	...
	uint32_t Address53= (uint32_t )(&image_temperature_w_const[0] - FLASH_BASE_ADDR);
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_temperature_w_HypRAM,Address53,(64*64*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-53\n\r");
#endif
