...
void Disp_imgDataHyperRAM_Init(void)
{
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_abs_detection_r_HypRAM,Address1,(24*20*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-1\n\r");
#endif
	...
	if(BSP_OSPI_NOR_Read(BSP_INSTANCE,ucimage_abs_detection_w_HypRAM,Address2,(24*20*4)))
	{
#if(DBGPrints_TestMacro == 1)
		printf("Copy Fail-2\n\r");
#endif
