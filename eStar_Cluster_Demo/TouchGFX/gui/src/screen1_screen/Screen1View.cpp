...
void Screen1View::IndicatorsStatus(IndicationStatus_t newIndicators)
{
    ...
    BlinkIndicator(newIndicators.indicators.Engine_Oil_indicator, tickCounterEngineOil, EngineOil_w, 7);
    ...
    BlinkIndicator(newIndicators.indicators.tachometer_indicator, tickCounterTachometer, RPMIcon_w,7);
